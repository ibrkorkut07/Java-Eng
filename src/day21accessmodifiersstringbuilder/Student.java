...
/*   If you use "protected" access modifier, you can access to it, from inside the entire package and 
 * from every child classes even they are in different packages
 */
