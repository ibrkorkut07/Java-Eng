...
6) Constructors do not have "return type" because Constructors are not method. Constructors are constructors.
...
//   Constructors can be overloaded as well
	public Car() {   // A constructor to build object from a class.		
	this.make = "Honda";
	this.model = "Pilot";
	this.price = 40000;
	this.year = 2021;		
