...
Note: If  you want to update original value by using any method, you have to do assignment, otherwise just by calling method does not update the variable which you used inside the method call.               
*/
