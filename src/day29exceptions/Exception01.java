...
1) You have to extend to "Exception" class like "extends Exception"
 2) To be able to put "exception message" on the console, you should create constructor with String parameter like "public IllegalGradeException(String message)"
3) Inside the constructor call parent constructor with message argument like "super(message);"
 4) After creating your own exception class you can use it in any method body whenever you need by  	  typing like "throw new IllegalGradeException("Do not make the grade less than 0 or greater than 100");"
 */
