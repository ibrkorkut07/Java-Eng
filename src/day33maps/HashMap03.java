...
/*
    ...
    7)What if same HashCode created from different keys
    	In a HashMap, if two or more Keys have the same hash code then the situation is referred to as Hash Collision. 
    	Hash Collisions are a common phenomena of hashing functions. 
    	A good design of the hashing function may reduce the occurrences of same hash code 
    	for different Keys but it cannot be avoided altogether.  	
...
public class HashMap03 {
	...
	public static void main(String[] args) {
		...
		//Normally Java wants to create unique hash codes but sometimes HashCodes can be same, this is called HashMap collision.
