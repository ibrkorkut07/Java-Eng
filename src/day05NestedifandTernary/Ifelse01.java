...
public class Ifelse01 {
	...
	public static void main(String[] args) {
		...
		& and && mean "and": If you use "&&" between 2 things it means you want both.
		For example; "tea && coffee" means I want both, just one of them will not be enough 
			 To get true from && operation all must be true.
			 true && (or just 1 &) true ==> true
			 true && false ==> false
			 false && true ==> false
			 false && false ==> false
			 	                
		Note: "&" and "&&" do the same but "&&" does not check the second condition if the first condition is false. "&" checks both conditions every time.
