...
/*
1) If you get "red underline" while you type code, it can be "checked exception - Compile Time Exception".
...
3) "IOException" is the parent of "FileNotFoundException" because of that when you use "IOException", no need to use "FileNotFoundException". But if you insist to use "FileNotFoundException" together with "IOException" in try-catch block, "FileNotFoundException" must be in the first catch block
